 ...
 * recherchePointChronopostParCoordonneesGeographiquesParService StructType
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopostParCoordonneesGeographiquesParService
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RecherchePointChronopostParCoordonneesGeographiquesParService extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setAccountNumber()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setPassword()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setCountryCode()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setCoordGeoLatitude()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setCoordGeoLongitude()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setType()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setProductCode()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setService()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setWeight()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setShippingDate()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setMaxPointChronopost()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setMaxDistanceSearch()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setHolidayTolerant()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setServiceList()
     * @uses RecherchePointChronopostParCoordonneesGeographiquesParService::setLanguage()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointChronopostParCoordonneesGeographiquesParService
     */
