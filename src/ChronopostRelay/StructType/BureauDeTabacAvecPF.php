...
/**
 * This class stands for bureauDeTabacAvecPF StructType
 * @subpackage Structs
 */
...
class BureauDeTabacAvecPF extends BureauDeTabacAvecCoord
{
     ...
     * @uses BureauDeTabacAvecPF::setPeriodeDeFermeture1Debut()
     * @uses BureauDeTabacAvecPF::setPeriodeDeFermeture1Fin()
     * @uses BureauDeTabacAvecPF::setPeriodeDeFermeture2Debut()
     * @uses BureauDeTabacAvecPF::setPeriodeDeFermeture2Fin()
     * @uses BureauDeTabacAvecPF::setPeriodeDeFermeture3Debut()
     * @uses BureauDeTabacAvecPF::setPeriodeDeFermeture3Fin()
