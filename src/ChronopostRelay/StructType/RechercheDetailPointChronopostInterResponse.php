...
/**
 * This class stands for rechercheDetailPointChronopostInterResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:rechercheDetailPointChronopostInterResponse
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RechercheDetailPointChronopostInterResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses RechercheDetailPointChronopostInterResponse::setReturn()
     ...
     * Set return value
     * @param \ChronopostRelay\StructType\PointCHRResult $return
     * @return \ChronopostRelay\StructType\RechercheDetailPointChronopostInterResponse
     */
