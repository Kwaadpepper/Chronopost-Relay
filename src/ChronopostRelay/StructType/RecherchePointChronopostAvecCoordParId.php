...
class RecherchePointChronopostAvecCoordParId extends AbstractStructBase
{
    /**
     * The id
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointChronopostAvecCoordParId::setId()
     * @param string $id
     */
     ...
     * Set id value
     * @param string $id
     * @return \ChronopostRelay\StructType\RecherchePointChronopostAvecCoordParId
     */
