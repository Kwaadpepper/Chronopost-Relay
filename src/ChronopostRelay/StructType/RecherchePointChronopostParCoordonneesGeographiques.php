...
class RecherchePointChronopostParCoordonneesGeographiques extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setAccountNumber()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setPassword()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setCoordGeoLatitude()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setCoordGeoLongitude()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setType()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setProductCode()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setService()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setWeight()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setShippingDate()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setMaxPointChronopost()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setMaxDistanceSearch()
     * @uses RecherchePointChronopostParCoordonneesGeographiques::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointChronopostParCoordonneesGeographiques
     */
