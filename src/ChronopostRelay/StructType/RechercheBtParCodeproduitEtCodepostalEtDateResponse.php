...
class RechercheBtParCodeproduitEtCodepostalEtDateResponse extends AbstractStructBase
{
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $rechercheBtParCodeproduitEtCodepostalEtDateResponseReturnItem) {
            ...
            if (!$rechercheBtParCodeproduitEtCodepostalEtDateResponseReturnItem instanceof \ChronopostRelay\StructType\BureauDeTabacAvecCoord) {
     ...
     * @param \ChronopostRelay\StructType\BureauDeTabacAvecCoord[] $return
     * @return \ChronopostRelay\StructType\RechercheBtParCodeproduitEtCodepostalEtDateResponse
     */
