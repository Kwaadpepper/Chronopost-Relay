...
class RechercheBtAvecPFParIdChronopostA2Pas extends AbstractStructBase
{
    /**
     * The id
     * Meta information extracted from the WSDL
     ...
     * @uses RechercheBtAvecPFParIdChronopostA2Pas::setId()
     * @param string $id
     */
     ...
     * Set id value
     * @param string $id
     * @return \ChronopostRelay\StructType\RechercheBtAvecPFParIdChronopostA2Pas
     */
