...
/**
 * This class stands for recherchePointChronopost StructType
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopost
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RecherchePointChronopost extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointChronopost::setAccountNumber()
     * @uses RecherchePointChronopost::setPassword()
     * @uses RecherchePointChronopost::setAddress()
     * @uses RecherchePointChronopost::setZipCode()
     * @uses RecherchePointChronopost::setCity()
     * @uses RecherchePointChronopost::setCountryCode()
     * @uses RecherchePointChronopost::setType()
     * @uses RecherchePointChronopost::setProductCode()
     * @uses RecherchePointChronopost::setService()
     * @uses RecherchePointChronopost::setWeight()
     * @uses RecherchePointChronopost::setShippingDate()
     * @uses RecherchePointChronopost::setMaxPointChronopost()
     * @uses RecherchePointChronopost::setMaxDistanceSearch()
     * @uses RecherchePointChronopost::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointChronopost
     */
