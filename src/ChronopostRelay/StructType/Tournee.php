...
/**
 * This class stands for tournee StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Tournee extends AbstractStructBase
{
    /**
     * The code
     ...
     * @uses Tournee::setCode()
     * @uses Tournee::setLocalise()
     * @uses Tournee::setType()
     * @param string $code
     * @param bool $localise
     * @param string $type
     */
     ...
     * Set code value
     * @param string $code
     * @return \ChronopostRelay\StructType\Tournee
     */
