...
/**
 * This class stands for recherchePointChronopostInterParService StructType
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopostInterParService
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RecherchePointChronopostInterParService extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointChronopostInterParService::setAccountNumber()
     * @uses RecherchePointChronopostInterParService::setPassword()
     * @uses RecherchePointChronopostInterParService::setAddress()
     * @uses RecherchePointChronopostInterParService::setZipCode()
     * @uses RecherchePointChronopostInterParService::setCity()
     * @uses RecherchePointChronopostInterParService::setCountryCode()
     * @uses RecherchePointChronopostInterParService::setType()
     * @uses RecherchePointChronopostInterParService::setProductCode()
     * @uses RecherchePointChronopostInterParService::setService()
     * @uses RecherchePointChronopostInterParService::setWeight()
     * @uses RecherchePointChronopostInterParService::setShippingDate()
     * @uses RecherchePointChronopostInterParService::setMaxPointChronopost()
     * @uses RecherchePointChronopostInterParService::setMaxDistanceSearch()
     * @uses RecherchePointChronopostInterParService::setHolidayTolerant()
     * @uses RecherchePointChronopostInterParService::setServiceList()
     * @uses RecherchePointChronopostInterParService::setLanguage()
     * @uses RecherchePointChronopostInterParService::setVersion()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointChronopostInterParService
     */
