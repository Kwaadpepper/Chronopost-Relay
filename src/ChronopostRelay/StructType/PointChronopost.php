...
/**
 * This class stands for pointChronopost StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class PointChronopost extends AbstractStructBase
{
    /**
     * The adresse1
     ...
     * @uses PointChronopost::setAdresse1()
     * @uses PointChronopost::setAdresse2()
     * @uses PointChronopost::setAdresse3()
     * @uses PointChronopost::setCodePostal()
     * @uses PointChronopost::setDateArriveColis()
     * @uses PointChronopost::setHorairesOuvertureDimanche()
     * @uses PointChronopost::setHorairesOuvertureJeudi()
     * @uses PointChronopost::setHorairesOuvertureLundi()
     * @uses PointChronopost::setHorairesOuvertureMardi()
     * @uses PointChronopost::setHorairesOuvertureMercredi()
     * @uses PointChronopost::setHorairesOuvertureSamedi()
     * @uses PointChronopost::setHorairesOuvertureVendredi()
     * @uses PointChronopost::setHorairesOuverturesFormates()
     * @uses PointChronopost::setIdentifiantChronopost()
     * @uses PointChronopost::setLocalite()
     * @uses PointChronopost::setNomEnseigne()
     * @uses PointChronopost::setTypeDePoint()
