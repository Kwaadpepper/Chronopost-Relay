...
class RechercheBtAvecPFParIdChronopostA2PasResponse extends AbstractStructBase
{
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $rechercheBtAvecPFParIdChronopostA2PasResponseReturnItem) {
            ...
            if (!$rechercheBtAvecPFParIdChronopostA2PasResponseReturnItem instanceof \ChronopostRelay\StructType\BureauDeTabacAvecPF) {
     ...
     * @param \ChronopostRelay\StructType\BureauDeTabacAvecPF[] $return
     * @return \ChronopostRelay\StructType\RechercheBtAvecPFParIdChronopostA2PasResponse
     */
