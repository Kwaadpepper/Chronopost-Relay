...
/**
 * This class stands for recherchePointRelaisParCoordonneesGeographiques StructType
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointRelaisParCoordonneesGeographiques
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RecherchePointRelaisParCoordonneesGeographiques extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setAccountNumber()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setPassword()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setCoordGeoLatitude()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setCoordGeoLongitude()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setType()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setProductCode()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setService()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setWeight()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setShippingDate()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setMaxPointChronopost()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setMaxDistanceSearch()
     * @uses RecherchePointRelaisParCoordonneesGeographiques::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointRelaisParCoordonneesGeographiques
     */
