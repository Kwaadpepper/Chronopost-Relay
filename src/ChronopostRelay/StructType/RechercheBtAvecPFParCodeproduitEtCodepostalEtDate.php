...
/**
 * This class stands for rechercheBtAvecPFParCodeproduitEtCodepostalEtDate
 * StructType
...
class RechercheBtAvecPFParCodeproduitEtCodepostalEtDate extends AbstractStructBase
{
    /**
     * The codeProduit
     * Meta information extracted from the WSDL
     ...
     * @uses RechercheBtAvecPFParCodeproduitEtCodepostalEtDate::setCodeProduit()
     * @uses RechercheBtAvecPFParCodeproduitEtCodepostalEtDate::setCodePostal()
     * @uses RechercheBtAvecPFParCodeproduitEtCodepostalEtDate::setDate()
     ...
     * @param string $codeProduit
     * @return \ChronopostRelay\StructType\RechercheBtAvecPFParCodeproduitEtCodepostalEtDate
     */
