...
/**
 * This class stands for recherchePointChronopostInter StructType
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopostInter
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class RecherchePointChronopostInter extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointChronopostInter::setAccountNumber()
     * @uses RecherchePointChronopostInter::setPassword()
     * @uses RecherchePointChronopostInter::setAddress()
     * @uses RecherchePointChronopostInter::setZipCode()
     * @uses RecherchePointChronopostInter::setCity()
     * @uses RecherchePointChronopostInter::setCountryCode()
     * @uses RecherchePointChronopostInter::setType()
     * @uses RecherchePointChronopostInter::setProductCode()
     * @uses RecherchePointChronopostInter::setService()
     * @uses RecherchePointChronopostInter::setWeight()
     * @uses RecherchePointChronopostInter::setShippingDate()
     * @uses RecherchePointChronopostInter::setMaxPointChronopost()
     * @uses RecherchePointChronopostInter::setMaxDistanceSearch()
     * @uses RecherchePointChronopostInter::setHolidayTolerant()
     * @uses RecherchePointChronopostInter::setLanguage()
     * @uses RecherchePointChronopostInter::setVersion()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointChronopostInter
     */
