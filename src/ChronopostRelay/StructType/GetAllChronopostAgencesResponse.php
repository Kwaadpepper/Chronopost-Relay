...
class GetAllChronopostAgencesResponse extends AbstractStructBase
{
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $getAllChronopostAgencesResponseReturnItem) {
            ...
            if (!$getAllChronopostAgencesResponseReturnItem instanceof \ChronopostRelay\StructType\PointChronopost) {
     ...
     * @param \ChronopostRelay\StructType\PointChronopost[] $return
     * @return \ChronopostRelay\StructType\GetAllChronopostAgencesResponse
     */
