...
/**
 * This class stands for bureauDeTabac StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class BureauDeTabac extends AbstractStructBase
{
    /**
     * The adresse1
     ...
     * @uses BureauDeTabac::setAdresse1()
     * @uses BureauDeTabac::setAdresse2()
     * @uses BureauDeTabac::setAdresse3()
     * @uses BureauDeTabac::setCodePostal()
     * @uses BureauDeTabac::setDateArriveColis()
     * @uses BureauDeTabac::setHorairesOuvertureDimanche()
     * @uses BureauDeTabac::setHorairesOuvertureJeudi()
     * @uses BureauDeTabac::setHorairesOuvertureLundi()
     * @uses BureauDeTabac::setHorairesOuvertureMardi()
     * @uses BureauDeTabac::setHorairesOuvertureMercredi()
     * @uses BureauDeTabac::setHorairesOuvertureSamedi()
     * @uses BureauDeTabac::setHorairesOuvertureVendredi()
     * @uses BureauDeTabac::setIdentifiantChronopostPointA2PAS()
     * @uses BureauDeTabac::setLocalite()
     * @uses BureauDeTabac::setNomEnseigne()
     ...
     * Set adresse1 value
     * @param string $adresse1
     * @return \ChronopostRelay\StructType\BureauDeTabac
     */
