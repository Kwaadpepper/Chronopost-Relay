...
/**
 * This class stands for tourneeComplete StructType
 * @subpackage Structs
 */
...
class TourneeComplete extends Tournee
{
     ...
     * @uses TourneeComplete::setCodeTourneeMaitre()
     * @uses TourneeComplete::setCodeTypeTournee()
     * @uses TourneeComplete::setCoutMensuelBatiment()
     * @uses TourneeComplete::setCubage()
     * @uses TourneeComplete::setCubageDistri()
     * @uses TourneeComplete::setDetailPrestation()
     * @uses TourneeComplete::setHeureTheoriqueRetour()
     * @uses TourneeComplete::setIdMoyenPropre()
     * @uses TourneeComplete::setIdSecteur()
     * @uses TourneeComplete::setIdSousTraitant()
     * @uses TourneeComplete::setIdVehicule()
     * @uses TourneeComplete::setPicking()
     * @uses TourneeComplete::setPlanDistri()
     * @uses TourneeComplete::setPosteComptable()
     * @uses TourneeComplete::setPourcentageCoChargement()
     * @uses TourneeComplete::setQualification()
     * @uses TourneeComplete::setSpot()
     * @uses TourneeComplete::setTrigrammeAgence()
     * @uses TourneeComplete::setTypeTournee()
     * @uses TourneeComplete::setZone()
     ...
     * @param string $codeTourneeMaitre
     * @return \ChronopostRelay\StructType\TourneeComplete
     */
