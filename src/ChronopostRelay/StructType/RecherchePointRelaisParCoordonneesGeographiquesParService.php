...
class RecherchePointRelaisParCoordonneesGeographiquesParService extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setAccountNumber()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setPassword()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setCountryCode()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setCoordGeoLatitude()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setCoordGeoLongitude()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setType()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setProductCode()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setService()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setWeight()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setShippingDate()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setMaxPointChronopost()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setMaxDistanceSearch()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setHolidayTolerant()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setServiceList()
     * @uses RecherchePointRelaisParCoordonneesGeographiquesParService::setLanguage()
     ...
     * @param string $accountNumber
     * @return \ChronopostRelay\StructType\RecherchePointRelaisParCoordonneesGeographiquesParService
     */
